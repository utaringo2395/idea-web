...
axios
  ...
  .then((response) => {
    ...
    //1.- Limpiamos el div
    document.getElementById("divBoletin").innerHTML = "";
    ...
    response.data.forEach((element) => {
      ...
      <div class="blogImagen">
        ...
        <div class="cardFooter">
           ...
           <button type="button"  class="btn  openLink" onclick="verMasbol(${
...
function verMasbol(titulo, fecha, img, nota) {
  document.getElementById("divModalBol").innerHTML = "";
  ...
  document.getElementById("divModalBol").innerHTML = `
        ...
        >
          ...
          `;
  //lanzamos el modal
  var modalBol = new bootstrap.Modal(document.getElementById("ModalBoletin"));
  modalBol.show();
